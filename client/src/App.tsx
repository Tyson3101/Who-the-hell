...
function App({
  ...
  tweet?: string;
  QuestionAsker?: { name: string; profilePic: string };
  showReply?: boolean;
}) {
  function tweeted() {}
    ...
    <>
      <section className="twitter-card">
        ...
        <div className="tweet">
          <p
            contentEditable={
              typeof showReply !== "undefined" ? showReply : true
            }
          >
        ...
        {typeof showReply !== "undefined" && showReply ? (
          <>
            <div className="reply">
              ...
              <div className="replyContent">
                <div className="left">
                  ...
                  />
                  <h4 contentEditable={true}>{replyPlaceHolder}</h4>
                </div>
                <div className="right">
                  <button
                    className="replyBtn"
